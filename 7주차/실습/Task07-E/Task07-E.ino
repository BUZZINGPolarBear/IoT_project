      ...
      {                         // if there's bytes to read from the client,
        ...
        { // if the byte is a newline character
          ...
          if (currentLine.length() == 0)
          {
            ...
            client.println("<label class=\"label\"><input name=\"hour\" class=\"input\" type=\"text\" style=\"width: 50px;\">Hour<input name=\"min\" class=\"input\" type=\"text\" style=\"width: 50px;\">Minute</label>");
